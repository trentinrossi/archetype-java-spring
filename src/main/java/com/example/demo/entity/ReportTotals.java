...
public class ReportTotals {
    ...
    @Column(name = "report_totals_id")
    private Long reportTotalsId;

    @Column(name = "page_total", nullable = false, precision = 11, scale = 2)
    private BigDecimal pageTotal;

    @Column(name = "account_total", nullable = false, precision = 11, scale = 2)
    private BigDecimal accountTotal;

    @Column(name = "grand_total", nullable = false, precision = 11, scale = 2)
    ...
    public ReportTotals(BigDecimal pageTotal, BigDecimal accountTotal, BigDecimal grandTotal) {
        this.pageTotal = pageTotal != null ? pageTotal : BigDecimal.ZERO;
        this.accountTotal = accountTotal != null ? accountTotal : BigDecimal.ZERO;
