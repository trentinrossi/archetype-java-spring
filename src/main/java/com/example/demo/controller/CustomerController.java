...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponseDto> getCustomerByCustomerId(@PathVariable Long customerId) {
    ...
    public ResponseEntity<CustomerResponseDto> createCustomer(
        ...
        log.info("Creating new customer with customer ID: {}", request.getCustomerId());
