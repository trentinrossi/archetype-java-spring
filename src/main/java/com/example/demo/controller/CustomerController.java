...
@Tag(name = "Customer Management", description = "APIs for managing customers in the credit card management system")
...
public class CustomerController {
    ...
    @Operation(summary = "Get customer by ID", description = "Retrieve a customer by their 9-digit customer ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create a new customer", description = "Create a new customer with validation of all required fields and business rules")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update an existing customer", description = "Update customer details by ID with atomic transaction")
    @ApiResponses(value = {
