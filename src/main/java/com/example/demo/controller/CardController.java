...
public class CardController {
    ...
    public ResponseEntity<CardResponseDto> getCardById(@PathVariable String cardNumber) {
        log.info("Retrieving card by card number: {}", cardNumber);
        return cardService.getCardById(cardNumber)
    ...
    public ResponseEntity<CardResponseDto> updateCard(@PathVariable String cardNumber,
