...
public class UpdateCustomerRequestDto {
    ...
    @Schema(description = "First name of the customer", example = "John", required = false)
    private String firstName;
    
    @Schema(description = "Middle initial", example = "M", required = false)
    private String middleInitial;
    
    @Schema(description = "Last name of the customer", example = "Doe", required = false)
    ...
    @Schema(description = "Customer status", example = "ACTIVE", required = false)
