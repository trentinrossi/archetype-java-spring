...
public class UpdateAccountRequestDto {
    ...
    @Schema(description = "Current account balance with 2 decimal places, signed amount", example = "2500.75", required = false)
    @Digits(integer = 10, fraction = 2, message = "Invalid current balance format")
    private BigDecimal currentBalance;

    @Schema(description = "Credit limit with 2 decimal places, signed amount", example = "10000.00", required = false)
    ...
    @Schema(description = "Cash credit limit with 2 decimal places, signed amount", example = "2000.00", required = false)
    ...
    @Schema(description = "Account opening date in YYYYMMDD format", example = "20230101", required = false)
    ...
    @Schema(description = "Account expiration date in YYYYMMDD format", example = "20280101", required = false)
    ...
    @Schema(description = "Card reissue date in YYYYMMDD format", example = "20250601", required = false)
    ...
    @Schema(description = "Current cycle credit amount with 2 decimal places, signed amount", example = "750.00", required = false)
    @Digits(integer = 10, fraction = 2, message = "Invalid current cycle credit format")
    private BigDecimal currentCycleCredit;

    @Schema(description = "Current cycle debit amount with 2 decimal places, signed amount", example = "450.00", required = false)
    ...
    @Schema(description = "Account active status indicator", example = "A", required = false)
