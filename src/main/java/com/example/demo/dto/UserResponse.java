...
public class UserResponse {
    @Schema(description = "Unique identifier of the user", example = "USER001", required = true)
    ...
    @Schema(description = "Type of the user (A=Admin, R=Regular)", example = "A", required = true)
    private String userType;

    @Schema(description = "Display name of the user type", example = "Admin", required = true)
