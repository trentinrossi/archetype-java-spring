...
public class UserListDTO {
    ...
    @Schema(description = "User ID of the first user in current page", example = "USR001", required = false)
    private String firstUserId;
    
    @Schema(description = "User ID of the last user in current page", example = "USR020", required = false)
