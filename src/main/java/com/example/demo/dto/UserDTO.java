...
public class UserDTO {
    ...
    @Schema(description = "Indicates if user has full access", example = "true", required = true)
    private boolean hasFullAccess;
    
    @Schema(description = "Indicates if user has limited access", example = "false", required = true)
    private boolean hasLimitedAccess;
