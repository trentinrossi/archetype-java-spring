-- V2__Create_admin_menu_options_table.sql
CREATE TABLE admin_menu_options (
    ...
    admin_user_id VARCHAR(8),
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_admin_menu_options_admin_user FOREIGN KEY (admin_user_id) REFERENCES admin_users(user_id)
);
...
CREATE UNIQUE INDEX idx_admin_menu_options_option_number_unique ON admin_menu_options(option_number);
