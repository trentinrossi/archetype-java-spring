...
(
    ...
    'N/A', CURRENT_TIMESTAMP - INTERVAL '30 days', CURRENT_TIMESTAMP - INTERVAL '30 days', 
    'ACC00001234', CURRENT_TIMESTAMP - INTERVAL '30 days', CURRENT_TIMESTAMP - INTERVAL '30 days'
),
(
    '02', 2, 'POS TERM', 'BILL PAYMENT - ONLINE', 1500.00,
    '4333333333333333', 999999999, 'BILL PAYMENT', 'N/A',
    'N/A', CURRENT_TIMESTAMP - INTERVAL '60 days', CURRENT_TIMESTAMP - INTERVAL '60 days', 
    'ACC00005678', CURRENT_TIMESTAMP - INTERVAL '60 days', CURRENT_TIMESTAMP - INTERVAL '60 days'
),
(
    '02', 2, 'POS TERM', 'BILL PAYMENT - ONLINE', 500.00,
    '4444444444444444', 999999999, 'BILL PAYMENT', 'N/A',
    'N/A', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP - INTERVAL '15 days', 
    'ACC00009012', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP - INTERVAL '15 days'
),
(
    '02', 2, 'POS TERM', 'BILL PAYMENT - ONLINE', 3000.00,
    '4555555555555555', 999999999, 'BILL PAYMENT', 'N/A',
    'N/A', CURRENT_TIMESTAMP - INTERVAL '45 days', CURRENT_TIMESTAMP - INTERVAL '45 days', 
    'ACC00007890', CURRENT_TIMESTAMP - INTERVAL '45 days', CURRENT_TIMESTAMP - INTERVAL '45 days'
);
